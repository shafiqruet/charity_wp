 ...
 */
class Asting_Google_Font_Select_Custom_Control extends WP_Customize_Control {
	/**
	...
	public function enqueue() {
		wp_enqueue_script( 'select2', ASTING_URI.'/assets/libs/select2/select2.min.js' , array( 'jquery' ), '4.0.6', true );
		wp_enqueue_script( 'ova-custom-controls', ASTING_URI . '/customize/assets/customizer.js', array( 'select2' ), '1.0', true );

		wp_enqueue_style( 'ova-custom-controls', ASTING_URI . '/customize/assets/customizer.css', array(), '1.1', 'all' );
		wp_enqueue_style( 'select2', ASTING_URI. '/assets/libs/select2/select2.min.css', array(), '4.0.6', 'all' );
	...
	public function render_content() {
		...
		if( !empty($this->fontList) ) {
			...
			<div class="google_fonts_select_control">
				...
				<div class="customize-control-description"><?php esc_html_e( 'Load Font Weight', 'asting' ); ?></div>
	...
	public function ova_getGoogleFontsx( $count = 30 ) {
		...
		$fontFile = ASTING_URI . '/customize/custom-control/api/google-fonts-alphabetical.json';
		if ( $this->fontOrderBy === 'popular' ) {
			$fontFile =  ASTING_URI . '/customize/custom-control/api/google-fonts-popularity.json' ;
		}
